document.addEventListener('DOMContentLoaded', () => {
    ...
    if (columnaLuz && columnaSombra)
    {
        columnaSombra.addEventListener('mouseenter', () => {
            columnaLuz.classList.add('atenuada');
        });

        columnaSombra.addEventListener('mouseleave', () => {
            columnaLuz.classList.remove('atenuada');
        });
    ...
    // 2. Función para mostrar el panel y el contenido correcto
    ...
    // 3. Función para ocultar el panel
